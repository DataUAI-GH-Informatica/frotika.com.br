...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                'include' => [
                    // O foco principal é backup de banco (backup:run --only-db).
                    // Deixe vazio para evitar zip de arquivos da aplicação por padrão.
                ],
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_EMAIL', env('MAIL_FROM_ADDRESS', 'gestor@frotika.com.br')),
