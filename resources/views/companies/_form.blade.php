...
<div class="grid gap-4 sm:grid-cols-2">
    ...
    <x-ui.input label="CEP" name="zip_code" :value="$val('zip_code')" data-cnpj-field="zip_code"
    ...
    <div class="grid grid-cols-[1fr_5rem] gap-3">
        <x-ui.input label="Cidade" name="city" :value="$val('city')" data-cnpj-field="city" />
        <x-ui.input label="UF" name="state" :value="$val('state')" data-cnpj-field="state" maxlength="2" />
    </div>

    <x-ui.input label="Telefone" name="phone" :value="$val('phone')" data-cnpj-field="phone" placeholder="Opcional" />
